...
print("\n\n\n BOOTED ParameterCount DEV MODE.\n\n")
decimals = int(input('How many decimals to round to: \n\n'))
...
unrounded_params = round(total_params, decimals)
...
if(manualcheck == 0):
    ...
    print("Automatic rounding: " + str(total_params) + "b\n")
else:
    print("Automatic rounding unsuccessful.\n")
print("Rounded (2): " + str(rounded_params) + "b\n")
print("Rounded (" + str(decimals) + "): " + str(unrounded_params) + "b\n")